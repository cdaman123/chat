...
Drafty is a text format used by Tinode to style messages. The intent of Drafty is to be expressive just enough without opening too many possibilities for security issues. One may think of it as JSON-encapsulated [markdown](https://en.wikipedia.org/wiki/Markdown). Drafty is influenced by FB's [draft.js](https://draftjs.org/) specification. As of the time of this writing [Javascript](https://github.com/cdaman123/tinode-js/blob/master/src/drafty.js), [Java](https://github.com/cdaman123/tindroid/blob/master/tinodesdk/src/main/java/co/cdaman123/tinodesdk/model/Drafty.java) and [Swift](https://github.com/cdaman123/ios/blob/master/TinodeSDK/model/Drafty.swift) implementations exist. A [Go implementation](https://github.com/cdaman123/chat/blob/master/server/drafty/drafty.go) can convert Drafy to plain text and previews.
